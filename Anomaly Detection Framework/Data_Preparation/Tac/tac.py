...
def textual_anomaly_contamination(dataset, dataset_name, inlier_topic, type_tac, anomaly_rate=0.1, is_trainset=None):
    ...
    if dataset_name == 'DBpedia14':
        return textual_anomaly_contamination_dbpedia14(dataset, inlier_topic, type_tac, anomaly_rate)
        
    if dataset_name == 'AGNews':
        return textual_anomaly_contamination_agnews(dataset, inlier_topic, type_tac, anomaly_rate)
...
def textual_anomaly_contamination_20newsgroups(dataset, inlier_topic, type_tac='ruff', anomaly_rate=0.1):
...
def textual_anomaly_contamination_wos(dataset, inlier_topic, type_tac='pantin', anomaly_rate=0.1):
...
def textual_anomaly_contamination_dbpedia14(dataset, inlier_topic, type_tac='pantin', anomaly_rate=0.1):
...
def textual_anomaly_contamination_agnews(dataset, inlier_topic, type_tac='fate', anomaly_rate=0.1):
