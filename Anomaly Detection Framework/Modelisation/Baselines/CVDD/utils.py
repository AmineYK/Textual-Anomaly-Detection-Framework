...
def cvdd_model_pipeline(data_train, data_test, emb_model, attention_size, n_attention_heads, embedding_type, seq_len, batch_size, shuffle, device, tokenizer=None, vocab=None):
