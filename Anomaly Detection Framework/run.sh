...
python3 main.py --dataset_name reuters --training_mode one_class --preprocessing --inlier_topic earn \
    ...
    --lambda_p 1.0 --alpha_scheduler "logarithmic" --n_epochs 40 --lr 0.01 --lr_milestones 15 25
